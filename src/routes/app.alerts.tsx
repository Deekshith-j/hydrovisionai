...
function Alerts() {
  ...
  const toneOf = (s: string) =>
    (s === "critical" ? "bad" : s === "medium" ? "warn" : "info") as any;
        ...
        <div className="flex flex-col gap-2">
          ...
          {active.map((a) => (
            <div
              ...
              className="grid grid-cols-[minmax(0,1fr)_auto] items-start gap-3 rounded-xl border border-white/[0.06] bg-white/[0.02] p-4 sm:flex sm:justify-between sm:items-center"
            >
