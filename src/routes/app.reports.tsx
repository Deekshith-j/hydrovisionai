...
const reports = [
  {
    ...
    desc: "Comprehensive quality analysis across all monitored parameters.",
    tag: "Monthly",
  },
  {
    title: "Environmental Report",
    desc: "Ecosystem-level health summary with seasonal insights.",
    tag: "Quarterly",
  },
  {
    title: "AI Prediction Report",
    desc: "Model performance, forecast accuracy and anomaly log.",
    tag: "Weekly",
  },
  {
    title: "Monthly Report",
    desc: "Rolling 30-day summary suitable for internal stakeholders.",
    tag: "Monthly",
  },
  {
    title: "Government Report",
    desc: "Compliance-ready format aligned to regulatory standards.",
    tag: "Regulatory",
  },
  {
    title: "Station Diagnostics",
    desc: "Hardware health, uptime, calibration and firmware status.",
    tag: "On demand",
  },
];
  ...
  return (
    <div className="flex flex-col gap-6">
      <SectionTitle
        eyebrow="Documents"
        title="Reports"
        description="Generate professional, export-ready reports."
        right={<StatusPill tone="info">6 templates</StatusPill>}
      />
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
        {reports.map((r, i) => (
          <GlassCard key={r.title} delay={i * 0.04}>
            <div className="inline-flex items-center rounded-full border border-cyan/25 bg-cyan/10 px-2 py-0.5 text-[10px] uppercase tracking-widest text-cyan">
              {r.tag}
            </div>
