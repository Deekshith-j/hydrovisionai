  ...
  return (
    <div className="flex flex-col gap-6">
      <SectionTitle
        ...
        title="AI Prediction"
        description="Multi-horizon forecasts across quality, risk and bloom probability."
        right={<StatusPill tone="good">Model · online</StatusPill>}
      />
      ...
      <GlassCard className="relative overflow-hidden">
        ...
        <div className="relative grid gap-6 md:grid-cols-3">
          ...
          <div>
            ...
            <div className="mt-2 font-display text-4xl font-semibold text-cyan">
              <AnimatedCounter value={prediction.confidence} suffix="%" />
            </div>
            <div className="mt-1 text-xs text-muted-foreground">
      ...
      <GlassCard className="p-0" delay={0.05}>
        <div className="flex flex-wrap items-center justify-between gap-3 px-5 pt-5">
          ...
          <div className="flex gap-2">
            {["Now", "24h", "48h", "72h"].map((h) => (
              <StatusPill key={h} tone="info">
                {h}
              </StatusPill>
            ))}
          </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <RiskTile
          ...
          value={prediction.algal_bloom_probability}
          tone="warning"
        />
      ...
      <GlassCard delay={0.05}>
        <div className="flex items-center gap-2 text-cyan">
          ...
          <span className="text-xs uppercase tracking-wider">Recommendation engine</span>
        </div>
      ...
      <div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
          <ComingSoon
            ...
            title="Random Forest"
            description="Tabular classifier for water safety verdicts, tuned against public datasets."
          />
          <ComingSoon
            tag="Ready for AI Model"
            title="XGBoost"
            description="Gradient-boosted risk scoring across pH, TDS, NTU and temperature."
          />
          <ComingSoon
            tag="Ready for AI Model"
            title="LSTM Forecasts"
            description="Sequence model for 24/48/72h horizon quality predictions."
          />
          <ComingSoon
            tag="Coming Soon"
            title="Satellite Intelligence"
            description="Chlorophyll-a retrievals from Sentinel-2 and MODIS pipelines."
          />
          <ComingSoon
            tag="Waiting for Device Integration"
            title="Computer Vision"
            description="ESP32-CAM feed for surface scum, foam and debris detection."
          />
          <ComingSoon
            tag="Ready for AI Model"
            title="TinyML On-Device"
            description="Quantized model inference at the edge for offline anomaly alerts."
          />
        </div>
      </div>
    </div>
...
function RiskTile({
  ...
  return (
    <GlassCard>
      ...
      <div className="mt-2 font-display text-4xl font-semibold" style={{ color }}>
