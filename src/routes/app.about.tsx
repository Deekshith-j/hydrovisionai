...
function About() {
  return (
    <div className="flex flex-col gap-6">
      <SectionTitle
        eyebrow="Platform"
        title="About HydroVision AI"
        description="Environmental intelligence for tomorrow's water."
      ...
      <GlassCard className="relative overflow-hidden">
        ...
        <div className="relative flex items-start gap-4">
          <div className="grid h-12 w-12 shrink-0 place-items-center rounded-2xl bg-[image:var(--gradient-primary)]">
            <Waves className="h-6 w-6 text-primary-foreground" />
          </div>
          <div>
            <div className="font-display text-2xl font-semibold">HydroVision AI</div>
            <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
              HydroVision AI is a government-grade environmental monitoring platform that fuses IoT
              sensing, machine learning, and geospatial intelligence to protect water bodies and the
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <GlassCard delay={0.1}>
          ...
          <div className="mt-1 text-xs text-muted-foreground">
            Environmental Intelligence Program
          </div>
        </GlassCard>
      </div>
    </div>
